...
import { getOwner } from "@/lib/identity-server";
...
export default async function AdministrationPage() {
  ...
  return <IdentityShell title={`Hola, ${owner.nombre}`} description="Tu sesión como propietario está activa.">
    ...
    <dl className="capabilities"><div><dt>Clientes, empleados y sucursales</dt><dd>En construcción</dd></div><div><dt>Configuración de la imprenta</dt><dd>En construcción</dd></div><div><dt>Pedidos y operación</dt><dd>En construcción</dd></div></dl>
    <LogoutButton />
  </IdentityShell>;
}
