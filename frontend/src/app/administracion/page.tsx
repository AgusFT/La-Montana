...
export default async function AdministrationPage() {
  ...
  return <IdentityShell title={`Hola, ${owner.nombre}`} description="Tu sesión como propietario está activa.">
    ...
    <div className="page-actions"><a className="refresh" href="/administracion/sucursales">Administrar sucursales</a><a className="refresh" href="/administracion/empleados">Administrar empleados</a><a className="secondary-link" href="/operacion">Ver sucursales operativas</a><LogoutButton /></div>
  </IdentityShell>;
}
