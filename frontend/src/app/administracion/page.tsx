...
export default async function AdministrationPage() {
  ...
  return <IdentityShell title={`Hola, ${owner.nombre}`} description="Tu sesión como propietario está activa.">
    ...
    <dl className="capabilities"><div><dt>Gestión de clientes</dt><dd>En construcción</dd></div><div><dt>Configuración de la imprenta</dt><dd>Borrador, modelo, pagos y recursos disponibles; fases 5–8 En construcción</dd></div><div><dt>Pedidos y operación</dt><dd>En construcción</dd></div></dl>
