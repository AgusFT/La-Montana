...
export default async function AdministrationPage() {
  ...
  return <IdentityShell title={`Hola, ${owner.nombre}`} description="Tu sesión administrativa está activa.">
    ...
    <dl className="capabilities"><div><dt>Gestión de clientes</dt><dd>En construcción</dd></div><div><dt>Configuración de la imprenta</dt><dd>Preparación, revisión, activación, programación e historial/comparación disponibles; reutilización con revisión obligatoria disponible; rollback En construcción</dd></div><div><dt>Pedidos y operación</dt><dd>En construcción</dd></div></dl>
