...
const allowed: Record<string, readonly string[]> = {
  ...
  "admin/catalogo": ["GET"], "admin/catalogo/papeles-predefinidos": ["POST"], "admin/catalogo/papeles-personalizados": ["POST"], "admin/catalogo/papeles-habilitados": ["PUT"], "admin/catalogo/formatos": ["POST"], "admin/catalogo/papeles": ["POST"], "admin/catalogo/servicios": ["POST"], "admin/catalogo/revisiones": ["POST"],
