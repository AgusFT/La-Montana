...
export default async function QuoteFilesPage({params}:{params:Promise<{id:string}>}){
 ...
 return <IdentityShell title="Archivos de la cotización" description="Consulta autorizada por sucursal. La revisión operativa de pedidos sigue En construcción."><PrivateFiles quote={id} version={0} internal/><a href="/operacion">Volver a mis sucursales</a></IdentityShell>;
}
