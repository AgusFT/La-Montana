...
const help=[
  ...
  ["Definí cuándo y cuánto debe pagar el cliente","La seña es un adelanto opcional del total. Elegí si querés usarla. El umbral por monto determina la revisión humana aunque no cobres seña. Los importes y porcentajes deben ser decisiones de tu imprenta.","Completá y guardá las opciones para habilitar recursos. Si querés, probá un importe en la simulación opcional: no cobra ni crea pedidos y no es necesaria para continuar."],
