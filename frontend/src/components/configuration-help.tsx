...
const help=[
  ...
  ["Definí cuándo y cuánto debe pagar el cliente","La seña es un adelanto del total. Las reglas indican cuándo se exige y cómo influye en la aprobación. Los importes y porcentajes deben ser decisiones de tu imprenta.","Completá las opciones correspondientes al modelo elegido, probá un importe en el simulador y guardá. La simulación es una prueba: no cobra ni crea pedidos. Después configurá los recursos."],
  ...
  ["Indicá cuándo y cómo se entregan los trabajos","Los horarios, tiempos de preparación y modalidades permiten calcular fechas y capacidad. Los puntos de retiro y las zonas de envío solo son necesarios para las modalidades que ofrezcas.","Completá los horarios y elegí las modalidades. Guardá antes de abrir puntos o zonas; sus formularios también se guardan en este borrador. Usá la simulación y luego revisá el resumen."],
