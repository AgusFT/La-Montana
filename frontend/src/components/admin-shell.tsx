...
export function AdminShell({ title, description, name, children, active="catalogo" }: { title:string; description:string; name:string; children:React.ReactNode; active?:"catalogo"|"configuracion"|"puntos" }) {
