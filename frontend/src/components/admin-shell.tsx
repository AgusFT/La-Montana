...
export function AdminShell({ title, description, name, children, active="catalogo" }: { title:string; description:string; name:string; children:React.ReactNode; active?:"catalogo"|"configuracion" }) {
  return <div className={`admin-layout${active==="configuracion"?" configuration-mode":""}`}>
    <aside className="admin-sidebar"><a href="/administracion" className="admin-brand"><span aria-hidden="true">△</span><span>La Montaña<small>IMPRESIONES</small></span></a><p className="admin-nav-label">ADMINISTRACIÓN</p>
      <nav aria-label="Navegación administrativa"><a href="/administracion"><AdminIcon kind="home"/>Dashboard</a><a href="/administracion/catalogo" aria-current={active==="catalogo"?"page":undefined}><AdminIcon kind="catalog"/>Servicios y precios</a><a href="/administracion/configuracion" aria-current={active==="configuracion"?"page":undefined}><AdminIcon kind="lock"/>Configurador</a><a href="/administracion/sucursales"><AdminIcon kind="branch"/>Sucursales</a><a href="/administracion/empleados"><AdminIcon kind="people"/>Empleados</a><a href="/cuenta/seguridad"><AdminIcon kind="lock"/>Seguridad de la cuenta</a></nav>
