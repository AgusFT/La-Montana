...
## Estado actual · entrega 38

El flujo principal está implementado, incluida la reprogramación aceptada por el cliente. La suite vigente aprobó 154 pruebas de backend; el navegador completó tres recorridos D1 por empleados y la regresión D2/versiones hasta cierre. Docker Compose se construyó desde una instalación vacía y se verificó la persistencia al recrear los cinco contenedores. **La demo completa sigue en verificación:** faltan los recorridos finales manual/seña pura/corrección D1 y la revisión visual restante.
