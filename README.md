...
Guardar esta selección **no activa reglas ni habilita pedidos**. La entrega 11 implementa parámetros financieros y ejemplos calculados de fase 3. La entrega12 agrega recursos/capacidades declarados y servicios por sucursal. Horarios, entregas, simulación integral, activación segura e historial operativo siguen En construcción. La entrega 10 habilita cancelar el borrador con contraseña y código por correo, como exige el mock; también se puede seguir editando el existente.
