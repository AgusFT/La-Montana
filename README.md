...
No hay semillas comerciales ni cuentas de muestra en el producto. Usar como base/rollback, cotizaciones, PDF, pagos, producción y entregas reales siguen dentro del alcance pendiente; la activación verificada no equivale a una demo E2E terminada.
...
Usar como base y rollback permanecen **En construcción** y siguen incluidos en v0.1. La consulta no los simula. El primero creará un nuevo borrador con origen y revisión obligatoria de fases2–6; el segundo recuperará la predecesora efectiva como una nueva versión autorizada. No habilitará edición de una histórica ni reescribirá su vigencia.
