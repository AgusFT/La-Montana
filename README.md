...
Los horarios habituales pertenecen a la versión operativa. La zona IANA de cada calendario se captura desde la sucursal al primer guardado y no cambia silenciosamente al editar sus datos; guardar su eliminación y después volver a incorporar explícitamente el calendario tomará la zona actual. Los siete días admiten una ventana cada uno, como el mock. Las franjas múltiples, cupos y excepciones de entrega se incorporarán con sus destinos, todavía En construcción.
