...
**Disponibilidad en construcción** indica que aún falta el estado operativo temporal, que será independiente de la versión. No se afirma que el punto esté operativo. Tampoco se ofrecen reservas ni se simula una entrega confirmada. La validación de fase5 comprueba relaciones útiles y mantiene un bloqueo explícito hasta integrar disponibilidad y oferta real. El siguiente bloque debe completar habilitar/deshabilitar temporalmente, recordatorio de puntos deshabilitados y protección de compromisos existentes, sin exigir motivo ni fecha final.
