...
La simulación domiciliaria solicita los tres datos territoriales y muestra zona resuelta, llegada, próxima disponibilidad, ventana, costo y cupo configurados. Rechaza domicilios sin cobertura. El costo no es un cargo registrado y el cupo no representa plazas libres: pedidos, reservas y activación siguen **En construcción**. Se usa horario de24horas y se distingue zona del origen/destino.
