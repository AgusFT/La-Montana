...
Después de revisar las advertencias y corregir los bloqueos en fase6, **Continuar a fase7** abre la decisión de aplicación. La selección comienza vacía. Elegir Activar ahora, ingresar un motivo y continuar a Verificación de seguridad; allí se reingresa la contraseña y se solicita el código del buzón Mailpit. La acción final vuelve a validar la revisión y activa la configuración. La entrega20 agrega programación operativa; el adelanto manual y el historial completo continúan dentro del alcance pendiente.
...
La fase1 muestra programación, próximo intento y los últimos cincuenta resultados. **Actualizar programación** recupera el estado real sin simular transiciones. El panel de disponibilidad admite identidades de la activa y del cambio pendiente, incluidas las programadas, para poder resolver una disponibilidad temporal sin editar el contenido cerrado. Adelanto/reintento manual, intentos durables de activación inmediata, historial completo, comparación, base y rollback siguen pendientes y se completarán en las siguientes entregas. No hay aún cotizaciones ni pedidos reales.
