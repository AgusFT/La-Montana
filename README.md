...
Plan revisión 10. El botón **Agregar todos los papeles (21)** permite habilitar de una vez todos los tamaños y gramajes precargados, aunque haya un filtro visible. Muestra progreso, bloquea envíos mientras guarda y queda deshabilitado cuando todos están habilitados. Conserva el control individual, los papeles personalizados y las revisiones comerciales. No requiere migración de base.
