...
Zonas domiciliarias con sus costos/franjas/cupos, reservas y oferta real de entrega **siguen dentro de v0.1 y pendientes**, marcados En construcción. Habilitar un checkbox no certifica una modalidad: validación de puntos/envío permanece bloqueada hasta contar con destinos utilizables. La validación local de retiro no sustituye la futura revisión integral, la reserva atómica ni la activación segura.
