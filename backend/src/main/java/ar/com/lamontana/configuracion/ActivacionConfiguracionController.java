...
public class ActivacionConfiguracionController {
 ...
 @PostMapping("/confirmar") public ConfiguracionService.Version confirmar(@PathVariable UUID borrador,@Valid @RequestBody Confirmar input,Principal actor){preparar(actor.getName());return activacion.confirmar(borrador,input,actor.getName());}
