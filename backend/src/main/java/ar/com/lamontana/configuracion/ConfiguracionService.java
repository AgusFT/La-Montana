...
public class ConfiguracionService {
    ...
    public record Borrador(UUID codigoPublico,long numero,long version,String estado,Modelo modelo,Criterio criterio,
                           Instant creadaEn,Instant actualizadaEn,String actor) {}
    public record Estado(Borrador borrador) {}
    ...
    private void bloquear() { jdbc.execute("SELECT pg_advisory_xact_lock(764003)"); }
    ...
    private void registrar(UUID operacion,String tipo,long id,long actor,String huella,String evento,long version) {
    ...
    private Borrador cargar(UUID codigo) {
